...
func process_command(cmd, parts):
	...
	match cmd:
		...
		"help":
			...
			print_to_terminal("  [color=#ffff00]rm[/color]      : Remove a file (e.g., [color=#add8e6]rm .daemon_hydra[/color])")
			...
			print_to_terminal("  [color=#ffff00]./[/color]      : Execute a program (e.g., [color=#add8e6]./unlock.exe[/color])")
